...
{
    public partial class AbitList : Form
    {
        #region Fields
...
Application.Id as AppId,
                            ...
                            Application.DateOfStart as 'Дата подачи',
                            CASE WHEN Application.IsApprovedByComission=1 THEN 1 ELSE 0 END AS Appr ,
                            ...
                            --'' as FileIsApproved,                            
                            CASE WHEN Application.isViewed=0 THEN 'да' ELSE 'нет' END AS IsViewed 
            ...
            dgvList.Columns["AppId"].Visible = false;
            ...
            dgvList.Columns["FileIsApproved"].HeaderText = "Имеются отклоненные файлы";
            dgvList.Columns["IsViewed"].HeaderText = "Имеются непросмотренные заявления";
        ...
        private void dgvList_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Guid id = (Guid)dgvList.Rows[e.RowIndex].Cells["AppId"].Value;
            int _AbitType = (int)dgvList.Rows[e.RowIndex].Cells["AbiturientTypeId"].Value;

            Util.OpenAbiturientCard(this, id, _AbitType);
        }
        ...
        private void dgvList_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            if (e.ColumnIndex == dgvList.Columns["IsViewed"].Index)
            {
                if (dgvList.Rows[e.RowIndex].Cells["IsViewed"].Value.ToString().Contains("да"))
                    e.CellStyle.BackColor = Color.LightBlue;
                return;
            }
            else if (e.ColumnIndex == dgvList.Columns["FileIsApproved"].Index)
            {
                if (dgvList.Rows[e.RowIndex].Cells["FileIsApproved"].Value.ToString().Contains("да"))
                    e.CellStyle.BackColor = Color.OrangeRed;
                return;
            }
            else if (e.ColumnIndex == dgvList.Columns["ФИО"].Index)
            {
