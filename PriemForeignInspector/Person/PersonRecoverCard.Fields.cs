...
namespace PriemForeignInspector
{
    partial class PersonRecoverCard
    {
        ...
        {
            get { return tbYearOfDisorder.Text.Trim(); }
            set { tbYearOfDisorder.Text = value; }
        }
        public string DisorderEducationName
        {
            get { return tbDisorderEducationName.Text.Trim(); }
            set { tbDisorderEducationName.Text = value; }
        }
